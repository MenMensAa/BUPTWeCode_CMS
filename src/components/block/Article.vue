<template>
    <div>
        <el-button class="add-board" type="primary" plain @click="addDeleteArticle">解封帖子</el-button>
        ...
        <el-table border :data="articles" :height="620">
            ...
            <el-table-column label="操作" width="95">
                <template slot-scope="scope">
                    <el-button type="primary" icon="el-icon-delete" size="small" @click="deleteArticleHandler(scope.row, scope.$index)">恢复</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    updated() {
        if (!this.inited) {
            this.$refs.pagenator.initPagenator(get_article, {status: 0})
            this.inited = true
        }
    },
    data() {
